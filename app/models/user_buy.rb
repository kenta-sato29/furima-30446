class UserBuy
  ...
  def save
    ...
    Address.create(post: post, shipment_source_id: shipment_source_id, first_number: first_number, second_number: second_number, building_name: building_name, purchase_id: item_id)
  end
end